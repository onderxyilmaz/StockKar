...
import type { Warehouse as WarehouseType, ProductWithRelations } from "@stockkar/shared";
        ...
        <div className="flex items-center gap-2">
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {editingWarehouse ? "Depo bilgilerini düzenleyin." : "Yeni bir depo eklemek için formu doldurun."}
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
